...
function getBizServices(v1,cb) {
    config.acquire(function (err, connection) {
        ...
        var jsonArray = [];
        var query = "SELECT * FROM BUSINESS_SERVICE BS LEFT JOIN PROFESSIONAL_MSTR PM ON PM.ID = BS.PROF_ID WHERE BS.SERVICE_TYPE <> 'Principle Agent' AND BS.COMPANY_ID='"+v1.ComId+"' ";
